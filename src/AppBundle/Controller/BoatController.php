...
class BoatController extends Controller
{
	...
	/**
	 * @Route("/admin/boat/edit", name="addboat")
	 */
	...
	/**
	 * @Route("/boat/{id}/document/edit", name="addboatdocument")
	 */
	...
	public function editMaintenance(Request $request, $id)
	{
		...
		$form = $this->createFormBuilder($boat)
            ...
            ->add('engineHoursCheck', 'date', array('required' => false))
            ->add('waxedAndPolished', 'date', array('required' => false))
            ->add('chargingChecked', 'date', array('required' => false))
            ->add('greasingSteering', 'date', array('required' => false))
            ->add('vaselineUpholstery', 'date', array('required' => false))
